...
public class InstituteManager implements InstituteManagerRemote {
    ...
    @Override
    public Institute saveInstitute(User u,Institute institute) throws RuntimeException {
        if (institute != null) {
    ...
    @Override
    public Institute getInstituteById(User u,long id) throws RuntimeException {
        if (id > 0) {
