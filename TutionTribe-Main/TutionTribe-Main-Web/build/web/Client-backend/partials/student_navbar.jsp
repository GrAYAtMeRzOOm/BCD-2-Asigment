<%-- 
    ...
    Created on : Sep 11, 2022, 10:55:22 PM
    Author     : grays
--%>
...
<!--    <ul class="navbar-nav">
    ...
    <ul class="navbar-nav navbar-nav-right">
      <li class="nav-item nav-logout d-none d-md-block me-3">
          <a class="nav-link" id="lb_userId" href="#">Username</a>
      </li>
      <li class="nav-item nav-logout d-none d-md-block">
          <button onclick="logout()" class="mdi mdi-logout btn btn-sm btn-danger menu-icon">Logout</button>
      </li>
